...
func (s *Server) ListenAndServe() error {
	...
	mux.HandleFunc("/time-machine", AuthMiddleware(handler.ServeTimeMachinePage))
	mux.HandleFunc("/war-room", AuthMiddleware(handler.ServeWarRoomPage))
	mux.HandleFunc("/api/time-machine/sessions", AuthMiddleware(handler.ListTimeMachineSessions))
	mux.HandleFunc("/api/time-machine/commands", AuthMiddleware(handler.GetTimeMachineCommands))
